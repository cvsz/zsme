  ...
  return (
    <div className="page-stack">
      ...
      {editingAccount ? (
        <section className="panel" aria-labelledby="edit-account-title">
          ...
          <form className="form-grid" onSubmit={handleUpdateAccount}>
            ...
            <div className="panel-grid two-column"><label className="checkbox-field"><input type="checkbox" name="is_control" defaultChecked={editingAccount.is_control} /> <span>Control account</span></label><label className="checkbox-field"><input type="checkbox" name="is_active" defaultChecked={editingAccount.is_active} /> <span>Active account</span></label></div>
      ...
      <section className="metric-grid" aria-label={`${page.title} metrics`}>
        ...
        <DataCard label="Last activity" value="—" meta="Audit timestamp" status={viewState === "ready" ? "Use Audit" : "Awaiting API"} icon={FileClock} />
